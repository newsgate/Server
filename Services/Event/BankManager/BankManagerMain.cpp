...
/**
 * @file   NewsGate/Server/Services/Event/BankManager/MessageBankManagerMain.cpp
...
namespace
{
  ...
  const char USAGE[] = "Usage: EventBankManager <config_file> <orb options>";
}
...
*/
      ...
      bank_manager_impl_ = new NewsGate::Event::BankManagerImpl(this);
      ...
      bank_manager_corba_ref_ =
        NewsGate::Event::BankManager::_narrow(bank_manager.in());
